...
namespace CippSharp.Core.Containers
{
    ...
    public abstract class AHiddenDataAsset<T> : ADataAssetBase, IContainer<T>
    {
        /// <summary>
        /// The stored data
        /// </summary>
        ...
        [SerializeField, HideInInspector] protected T value = default(T);
        ...
        public static implicit operator T (AHiddenDataAsset<T> dataContainer)
        {
